...
\title{Kostenoptimalisatie van AI-coding-agents in productieomgevingen: een casus bij Uber}
...
De specifieke doelgroep van dit onderzoek zijn platformteams en engineering-leads bij middelgrote tot grote softwareorganisaties, die verantwoordelijk zijn voor de interne uitrol en het kostenbeheer van AI-coding-agents. Dit is een concrete, afgebakende doelgroep, in tegenstelling tot IT-professionals in het algemeen: het gaat specifiek om de teams die de infrastructuurkeuzes rond agentgebruik maken, zoals welke caching-, compressie- of routingstrategie toegepast wordt.

Dit leidt tot de volgende hoofdonderzoeksvraag: \emph{Welke combinatie van kostenoptimalisatietechnieken (agentgeschikte caching, prompt-compressie en model-routing) is het meest geschikt voor een platformteam zoals dat van Uber, om de operationele kosten van AI-coding-agents in een productieomgeving te verlagen, zonder de kwaliteit van de output significant te verminderen?}

Deze hoofdvraag wordt opgesplitst in deelvragen binnen het probleemdomein en het oplossingsdomein. Hoewel de deelvragen algemeen geformuleerd zijn voor AI-coding-agents in een productieomgeving, worden ze in dit onderzoek beantwoord vanuit de concrete situatie van een platformteam zoals dat van Uber, dat AI-coding-agents zoals Claude Code op grote schaal inzet.

Deelvragen probleemdomein:
\begin{itemize}
  \item Waarom schieten klassieke context- en semantische caching specifiek tekort bij LLM-agenttoepassingen, zoals de AI-coding-agents die een platformteam als dat van Uber inzet?
...
Het doel van dit onderzoek is een onderbouwd en vergelijkend overzicht te bieden van kostenoptimalisatietechnieken voor LLM-agenttoepassingen in productieomgevingen, primair gericht op een platformteam zoals dat van Uber, en bij uitbreiding op vergelijkbare platformteams bij andere softwareorganisaties die AI-coding-agents op schaal uitrollen.

Dit onderzoeksvoorstel is SMART afgebakend. Het is specifiek, aangezien het zich beperkt tot drie met naam benoemde technieken (agentgeschikte caching, prompt-compressie en model-routing) binnen één concreet probleemdomein, namelijk kostenbeheersing bij AI-coding-agents. Het is meetbaar, aangezien kostenbesparing, latency en kwaliteitsbehoud kwantificeerbare grootheden zijn die zowel uit de literatuur als uit de eigen proof-of-concept afgeleid kunnen worden. Het is haalbaar, aangezien de literatuurstudie en de PoC beide gebaseerd zijn op bestaande, publiek beschikbare tools, frameworks en gepubliceerde datasets, zonder dat hiervoor toegang tot interne bedrijfsdata nodig is. Het is relevant, aangezien het probleem recent aangetoond is in peer-reviewed onderzoek en zich in de praktijk voordoet bij minstens één groot, publiek gedocumenteerd bedrijf. Het is ten slotte tijdsgebonden: de volledige aanpak, inclusief literatuurstudie, PoC en eindredactie, is uitgewerkt binnen de beschikbare 12 weken van dit onderzoekstraject, zoals verder toegelicht in sectie~\ref{sec:methodologie}.
...
\textbf{Fase 3, oplossingsdomein: praktische uitwerking (weken 7 tot 10).} Om het onderzoek te onderbouwen met eigen, empirisch bewijs naast de literatuur, wordt een proof-of-concept (PoC) uitgewerkt. Hierbij wordt een eenvoudige AI-agent, opgebouwd rond een bestaand agentframework, ingezet op een representatieve, herhaalbare taak, bijvoorbeeld het automatisch beantwoorden van een reeks vergelijkbare codeerverzoeken. Op deze taak wordt agentgeschikte caching, zoals het cachen van planstructuren in plaats van volledige antwoorden, zelf geïmplementeerd en gemeten. De PoC vergelijkt het tokenverbruik, de kost en de latency met en zonder de toegepaste techniek, en toetst zo of de kostenbesparingen uit de literatuur zich ook in een eigen, gecontroleerde testopstelling laten reproduceren. Deze fase levert een concreet, meetbaar en herhaalbaar resultaat op, bovenop de literatuurstudie.
...
Het onderzoek moet een vergelijkend overzicht opleveren van kostenoptimalisatietechnieken voor LLM-agenttoepassingen. Voor elke techniek wordt een inschatting verwacht van de haalbare kostenbesparing, de invloed op kwaliteit en latency, en de situaties waarin de techniek het meest geschikt is. Daarnaast levert de proof-of-concept uit fase 3 concrete, zelf gemeten resultaten op over het tokenverbruik, de kost en de latency van een agenttaak met en zonder toegepaste agentgeschikte caching, wat toelaat de bevindingen uit de literatuur te toetsen aan een eigen, gecontroleerde testopstelling. Op basis van beide bronnen wordt een afwegingskader verwacht dat een platformteam zoals dat van Uber, en bij uitbreiding vergelijkbare platformteams, kan ondersteunen bij het maken van een onderbouwde keuze bij het ontwerpen van AI-coding-agents.

\section{Discussie en conclusie}%
\label{sec:conclusie}

Dit voorstel kadert een concreet en recent aangetoond probleem: klassieke LLM-cachingtechnieken schieten tekort bij AI-agenttoepassingen, waardoor de operationele kosten en latency van dergelijke toepassingen onnodig hoog blijven, zoals ook publiek geïllustreerd wordt door het budgetprobleem van Uber. Op basis hiervan wordt een onderzoek voorgesteld naar de effectiviteit van agentgeschikte caching, prompt-compressie en model-routing als oplossingsstrategieën. De voorgestelde methodologie combineert literatuuronderzoek met een eigen proof-of-concept, met als doel een praktijkgericht en empirisch onderbouwd afwegingskader op te leveren voor een platformteam zoals dat van Uber, binnen een tijdsbestek van 12 weken. Een mogelijke beperking van het onderzoek is de snelheid waarmee dit vakgebied evolueert, waardoor specifieke kostencijfers snel kunnen verouderen. Het voorgestelde afwegingskader is daarom opgezet om ook op langere termijn bruikbaar te blijven.
