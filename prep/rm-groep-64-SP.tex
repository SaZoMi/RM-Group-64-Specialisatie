...
\course{Research Methods, 2D, 2E1} 
\assignmenttype{Groepsopdracht}
\academicyear{2025-2026}
\title{Kostenoptimalisatie van AI-coding-agents: een vergelijking van caching, prompt-compressie en model-routing}
...
\begin{abstract}
  Uber besteedde in 2025 3,4 miljard dollar aan onderzoek en ontwikkeling, en toch was het volledige AI-budget van het bedrijf in april 2026 al opgebruikt door een snelle stijging in het gebruik van AI-coding-agents zoals Claude Code \autocite{Jain2026}. Dit voorbeeld illustreert een probleem dat verder reikt dan één bedrijf: bestaande technieken voor het cachen van LLM-antwoorden, zoals context caching en semantische caching, zijn ontworpen voor chatbot-achtige toepassingen en schieten tekort bij AI-agenttoepassingen, omdat deze meerdere planningsstappen na elkaar uitvoeren en hun output afhangt van externe data en omgevingscontext \autocite{Zhang2025}. Dit zorgt voor onnodig hoge operationele kosten en latency bij bedrijven die LLM-agenten inzetten in productie, terwijl prompt-compressie en model-routing in de literatuur wel als aanvullende technieken genoemd worden, zonder dat ze vergelijkend afgewogen zijn specifiek voor agenttoepassingen \autocite{Chen2024}. Dit onderzoeksvoorstel beschrijft een geplande studie naar welke combinatie van kostenoptimalisatietechnieken het meest geschikt is om de operationele kosten van AI-coding-agents in productie te verlagen, zonder de kwaliteit van de output significant te verminderen. Op basis van een literatuurstudie wordt eerst een probleem- en oplossingsdomein afgebakend rond drie technieken: agentgeschikte caching, prompt-compressie en model-routing. Vervolgens worden deze drie technieken, via bestaande implementaties (respectievelijk Agentic Plan Caching, LLMLingua en RouteLLM), in een eigen proof-of-concept vergelijkend getest op twintig coding-taken uit SWE-bench Lite, waarbij per techniek tokenverbruik, kost, latency en slaagkans gemeten worden ten opzichte van een baseline. Verwacht wordt dat elke techniek afzonderlijk een meetbare kostenbesparing oplevert, maar dat ze onderling verschillen in hun impact op kwaliteit en slaagkans, zodat geen enkele techniek in alle situaties optimaal blijkt. Het onderzoek moet zo resulteren in een onderbouwd afwegingskader voor platformteams die AI-coding-agents zoals Claude Code of Cursor intern uitrollen en beheren bij grote softwareorganisaties, zoals Uber, om LLM-kosten te beheersen zonder in te boeten op de productiviteit van deze tools.
\end{abstract}
...
\begin{quote}
 Welke combinatie van kostenoptimalisatietechnieken (agentgeschikte caching, prompt-compressie en model-routing) is het meest geschikt om de operationele kosten van AI-coding-agents in productie te verlagen, zonder de kwaliteit van de output significant te verminderen?
\end{quote}
