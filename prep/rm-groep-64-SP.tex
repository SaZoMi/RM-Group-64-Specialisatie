...
\begin{quote}
  Welke combinatie van kostenoptimalisatietechnieken is het meest geschikt om bij Uber de operationele kosten van AI-coding-agents in productie te verlagen, zonder de kwaliteit van de output significant te verminderen?
\end{quote}

Deze hoofdvraag wordt opgesplitst in deelvragen binnen het probleemdomein en het oplossingsdomein. De deelvragen zijn algemeen geformuleerd voor AI-coding-agents in een productieomgeving, maar worden in dit onderzoek beantwoord vanuit de concrete situatie van Uber, dat AI-coding-agents zoals Claude Code op grote schaal inzet.

Deelvragen probleemdomein:
\begin{itemize}
  \item Waarom schieten klassieke context- en semantische caching specifiek tekort bij LLM-agenttoepassingen, zoals de AI-coding-agents die Uber inzet?
...
Het doel van dit onderzoek is een onderbouwd en vergelijkend overzicht te bieden van kostenoptimalisatietechnieken voor LLM-agenttoepassingen in productieomgevingen, primair gericht op Uber, en bij uitbreiding op vergelijkbare platformteams bij andere softwareorganisaties die AI-coding-agents op schaal uitrollen.
